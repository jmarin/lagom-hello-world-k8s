package com.example.lagomhelloworldk8s.api
...
object Lagomhelloworldk8sService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The lagom-hello-world-k8s service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the Lagomhelloworldk8sService.
  */
trait Lagomhelloworldk8sService extends Service {
  ...
  override final def descriptor: Descriptor = {
    import Service._
    // @formatter:off
    named("lagom-hello-world-k8s")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(Lagomhelloworldk8sService.TOPIC_NAME, greetingsTopic _)
